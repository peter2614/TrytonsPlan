...
const searchbar = (props) => {
    ...
    return <div>
        <div style={{height: '6vh', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <input style={{fontFamily: 'Avenir', paddingLeft: '3%', backgroundColor: '#dddddd', fontSize: '2vh', height: '3vh', width: '14vw'}} type="search"
                   onChange={(event) => props.searchCourseHandler(event)} placeholder="Search FA18 Courses"/>
        </div>
        {courses}
    </div>;
};
