...
class CourseTree extends Component {
    ...
    render() {
        ...
        edgeDisplay = 
            ...
            />
        let heightOfCourseTree = '0'
        let widthOfCourseTree = '0'
        if (this.props.display == true) {
            heightOfCourseTree = '900';
            widthOfCourseTree = '1200'
        }
        return(
            <div>
                <div
                ...
                >
                <button id="close-CSS" style={{position: 'relative', height: '3vh', width: '3vh', marginLeft: '-7vw', marginTop: '.75vh', backgroundColor: '#49B', borderColor: '#49B'}} onClick={this.props.displayCourseTreeHandler}/>
                    <Sidebar 
                ...
                >
                    <svg
                        height={heightOfCourseTree} width={widthOfCourseTree}
